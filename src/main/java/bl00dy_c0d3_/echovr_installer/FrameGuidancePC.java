...
public class FrameGuidancePC extends BaseWizard {
    ...
    @Override
    protected String getWindowTitle() { return "Echo VR Installer v0.9.5-001"; }
    ...
    private void triggerDownload() {
        ...
        new Thread(() -> {
            ...
            downloader.setOnCompleteListener(() -> {
                ...
                UpdateService.applyUpdates(PC_MANIFEST_URL, binPath, dlProgressLabel, FrameGuidancePC.this, frameMain, () -> {
